# device common
git clone -b blaze https://github.com/kamleshhv/android_device_xiaomi_sm6150-common.git device/xiaomi/sm6150-common
...
# kernel 
git clone --depth=1 -b sleepy-k6a-inline https://github.com/kamleshhv/kernel_xiaomi_sm6150.git kernel/xiaomi/sm6150
